...
public abstract class Console 
{
   ...
   /**
    * Rend un caractère lu sur la console. Le caractère n'a vraiment été lu
    * que si eof() est faux après la lecture.
    * @return char
   ...
   /**
    * Annule l'effet de la dernière invocation de <code>lireChar</code>.
    * Ne fonctionne que si la dernière methode de lecture invoquée est
   ...
   /**
    * Ignore tous les caractères restant sur la ligne si on a déjà
    * lu au moins un caractère de la ligne.
   ...
   /**
    * Ignore tous les caractères "blancs" (espace, tabulation etc.)
    * Après l'invocation de cette méthode, on est soit en fin de flux,
    * soit sur un caractère non-blanc.
   ...
   /**
    * Ignore tous les caractères "blancs" dans la ligne courante.
    * Après l'invocation de cette méthode, on est soit en fin de flux,
    * soit en fin de ligne, soit sur un caractère non-blanc.
   ...
   /**
    * Rend une chaîne contenant tous les caractères rencontrés sur le
    * flux jusqu'à une fin de ligne ou la fin du flux.  L'éventuel
    * marqueur de fin de ligne ne fait pas partie de la chaîne rendue.
    * @return java.lang.String
   ...
   /**
    * Rend un booléen dont la représentation est lue à la console. 
    * Re-essaye tant que les caractères lus ne peuvent pas être
    * interprétés comme un booléen et que la fin du flux de caractères
    * n'est pas rencontrée.  Les mots <code>"true"</code> et
    * <code>"t"</code> sont interprétés comme la valeur booléenne
    * <code>true</code>, sans tenir compte de la casse.  Les mots
    * <code>"false"</code> et <code>"f"</code> sont interprétés comme la
   ...
   /**
    * Rend un octet dont la représentation décimale est lue sur la
    * console.  Re-essaie tant que les caractères lus ne constituent pas la
    * représentation d'un entier, ou si l'entier correspondant ne peut pas
   ...
   /**
    * Rend un short dont la représentation décimale est lue sur la
    * console.  Re-essaie tant que les caractères lus ne constituent pas la
    * représentation d'un entier, ou si l'entier correspondant ne peut pas
    * être codé sur un short.
    * @return short
   ...
   /**
    * Rend un float dont la représentation décimale est lue sur la
    * console.  Re-essaie tant que les caractères lus ne constituent pas la
    * représentation d'un flottant, ou si le flottant correspondant ne peut
    * pas être codé sur un float.
    * @return float
   ...
   /**
    * Rend un double dont la représentation décimale est lue sur la
    * console.  Re-essaie tant que les caractères lus ne constituent pas la
    * représentation d'un flottant, ou si le flottant correspondant ne peut
    * pas être codé sur un double.
    * @return double
    ...
    * <code>fmt</code>.  Le format est utilisé à partir du premier
    * caractère non-blanc suivant la position courante.  Échoue et rend
    * <code>null</code> si les caractères lus ne peuvent pas être
    * interprétés comme la représentation décimale d'un nombre.
   ...
   /**
    * Indique si le nombre <code>n</code> peut être représenté 
   ...
   /**
    * Indique s'il existe un caractère suivant dans le flux. Peut provoquer
